...
const (
	QuizGeneratorSystemPrompt = "You are a dedicated and powerful question generator. Accuracy is your top priority, and you take great care in ensuring that every question you create is factually correct and meaningful. Your goal is generate varied and comprehensive educative questions."
	DesirableQuizCriteria     = "### Criteria for Desirable Questions ###\n" +
